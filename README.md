...
1.0.1 正在准备 Microsoft Edge Add-ons 首次审核。商店页面开放后，官网会把主安装入口切换为商店安装。

### GitHub Release 测试版

[下载视频笔记 1.0.1 ZIP](https://github.com/IronUnicorn66/video-notes/releases/download/v1.0.1/video-notes-edge-1.0.1.zip)
· [SHA-256 校验文件](https://github.com/IronUnicorn66/video-notes/releases/download/v1.0.1/video-notes-edge-1.0.1.zip.sha256)
...
npm run build
npm run package
unzip -t artifacts/video-notes-edge-1.0.1.zip
cd artifacts && shasum -a 256 -c video-notes-edge-1.0.1.zip.sha256
```
