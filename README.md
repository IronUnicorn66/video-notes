...
- Introduces a new brand icon: three video moments automatically converge into one structured note with a screenshot and text, optimized for small browser-toolbar sizes.
