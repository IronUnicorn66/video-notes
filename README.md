...
Version 1.0.18 is being prepared for the first Microsoft Edge Add-ons review. Once the listing is available, the website will point its primary install action to the store.

### GitHub Release preview

[Download Video Notes 1.0.18 ZIP](https://github.com/IronUnicorn66/video-notes/releases/download/v1.0.18/video-notes-edge-1.0.18.zip)
· [SHA-256 checksum](https://github.com/IronUnicorn66/video-notes/releases/download/v1.0.18/video-notes-edge-1.0.18.zip.sha256)
