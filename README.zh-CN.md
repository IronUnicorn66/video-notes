...
- 对已暴露原生字幕轨道的 YouTube 视频显示完整字幕、覆盖范围、可配置的 5/10/20 条合并阅读、独立字号调节和时间跳转。
...
1.0.21 正在准备 Microsoft Edge Add-ons 首次审核。商店页面开放后，官网会把主安装入口切换为商店安装。

### GitHub Release 测试版

[下载视频笔记 1.0.21 ZIP](https://github.com/IronUnicorn66/video-notes/releases/download/v1.0.21/video-notes-edge-1.0.21.zip)
· [SHA-256 校验文件](https://github.com/IronUnicorn66/video-notes/releases/download/v1.0.21/video-notes-edge-1.0.21.zip.sha256)
