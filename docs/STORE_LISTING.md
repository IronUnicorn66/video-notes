...
- Manifest V3 版本为 1.0.26，默认语言为 `zh_CN`。
...
- 全量自动化测试、构建和 ZIP 完整性校验均通过；此前已在 Edge 150 完成加载与字幕烟测、在 Edge 152 确认本地翻译语言包下载进度与播放器当前进度定位，本批次新增 320px 中英文时间线工具栏、弯箭头撤销/反撤销和 10–24px 笔记字号验证，其余人工路径见 `docs/ACCEPTANCE.md`。
